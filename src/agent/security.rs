...
impl CommandWhitelist {
    ...
    /// Create a default whitelist allowing all cloudapps resource commands.
    pub fn default_cloudapps() -> Self {
        let allowed = [
            "activities",
            "alerts",
            "entities",
...
mod tests {
    ...
    fn test_whitelist() {
        ...
        assert!(wl.is_allowed("data-enrichment"));
